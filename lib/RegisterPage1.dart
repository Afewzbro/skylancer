...
import 'package:skylancer/HizmetVerRegisterPage1.dart';
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  if(_hizmetSecim=="hizmetAl"){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => HizmetAlRegisterPage() ));
                  }
                  if(_hizmetSecim=="hizmetVer"){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => HizmetVerRegisterPage1() ));
                  }
                  if(_hizmetSecim=="empty"){
                  final snackBar = SnackBar(
                  content: Text('Snackbar Mesajı'),
