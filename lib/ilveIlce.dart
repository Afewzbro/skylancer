class IlIlceVerileri {
  static Map<String, List<String>> ilIlceMap = {
    ...
    'Gaziantep': ['Araban', 'İslahiye', 'Karkamış', 'Nizip', 'Oğuzeli', 'Şahinbey', 'Şehitkamil', 'Yavuzeli'],
    ...
    'Siirt': ['Baykan', 'Eruh', 'Kurtalan', 'Pervari', 'Siirt', 'Şirvan'],
    ...
    'Tekirdağ': ['Çerkezköy', 'Çorlu', 'Ergene', 'Hayrabolu', 'Kapaklı', 'Malkara', 'Marmara Ereğlisi', 'Muratlı', 'Saray', 'Şarköy', 'Tekirdağ'],
    'Tokat': ['Almus', 'Artova', 'Başçiftlik', 'Erbaa', 'Niksar', 'Pazar', 'Reşadiye', 'Sulusaray', 'Tokat', 'Turhal', 'Yeşilyurt', 'Zile'],
    'Trabzon': ['Akçaabat', 'Araklı', 'Arsin', 'Beşikdüzü', 'Çarşıbaşı', 'Çaykara', 'Dernekpazarı', 'Düzköy', 'Hayrat', 'Köprübaşı', 'Maçka', 'Of', 'Ortahisar', 'Sürmene', 'Tonya', 'Trabzon', 'Vakfıkebir', 'Yomra'],
    ...
    'Yalova': ['Altınova', 'Armutlu', 'Çiftlikköy', 'Termal', 'Yalova'],
    'Yozgat': ['Akdağmadeni', 'Aydıncık', 'Boğazlıyan', 'Çandır', 'Çayıralan', 'Çekerek', 'Kadışehri', 'Sarıkaya', 'Sorgun', 'Şefaatli', 'Yenifakılı', 'Yerköy', 'Yozgat'],
    'Zonguldak': ['Alaplı', 'Çaycuma', 'Devrek', 'Gökçebey', 'Karadeniz Ereğli', 'Kilimli', 'Kozlu', 'Zonguldak']
  };

  static List<String> iller = ilIlceMap.keys.toList();

  static List<String>? ilceler(String il) {
    return ilIlceMap[il];
  }
}